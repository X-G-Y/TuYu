...
import static com.example.ihitsz.PostUploadRequest.RegisterActivity.LOGIN;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visitorButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), com.example.ihitsz.Activity.basic.class);
                startActivity(intent);
            }
        });
